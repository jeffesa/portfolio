<template>
  <div class="networks grid">
    ...
    <div class="flex">
      <a class="flex items-center" href="https://github.com/sarahdayan/" rel="noopener noreferrer" target="_blank">
        <svg viewBox="0 0 24 24" aria-hidden="true" class="w-4 h-4 mr-16 fill-current">
          <path
        ...
        <div class="w-16 p-2 ml-8">
          <svg fill="none" stroke="currentColor" viewBox="0 0 12 12" aria-hidden="true" class="flex-none mt-2 stroke-current">
            <path
